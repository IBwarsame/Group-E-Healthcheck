"""
Django settings for SEVENTYSEVENMARKS project.
...
AUTH_PASSWORD_VALIDATORS = [
    # ! PASSWORD VALIDATION TEMPORARILY DISABLED FOR TESTING PURPOSES
    # {
...
# Email settings
# For development/testing - prints emails to console instead of sending them
